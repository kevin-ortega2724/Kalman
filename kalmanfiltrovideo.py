...
# Crear la carpeta para almacenar los cuadros con recuadro
...
while True:
    ...
    # Dibujar el punto rojo y el indicador de posición y velocidad en el cuadro del video
    ...
    # Guardar el cuadro con el recuadro en la carpeta "frames"
    frame_filename = f'frames/frame_{frame_counter:04d}.jpg'
